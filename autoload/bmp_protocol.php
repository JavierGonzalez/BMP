...
define('BMP_PROTOCOL', [
    ...
    'actions' => [
        ...
        '04' => [
            ...
            1 => ['size' =>  32, 'name'=>'txid'],
            2 => ['size' =>   1, 'name'=>'type_vote',        'decode'=>'hexdec', 'options'=>[0=>'action', 1=>'one_election', /*2=>'multiple', 3=>'preferential_3', 4=>'preferential_5', 5=>'preferential_10'*/]],
        ...
        '05' => [
            ...
            'status'        => 'implemented',
            'description'   => '',
            1 => ['size' =>   1, 'name'=>'type_voting',       'decode'=>'hexdec', 'options'=>[0=>'default']],
            2 => ['size' =>   1, 'name'=>'type_vote',         'decode'=>'hexdec', 'options'=>[1=>'one_election', /*2=>'multiple', 3=>'preferential_3', 4=>'preferential_5', 5=>'preferential_10'*/]],
            3 => ['size' =>   1, 'name'=>'parameters_num',    'decode'=>'hexdec'],
            4 => ['size' =>   3, 'name'=>'blocks_to_finish',  'decode'=>'hexdec', 'min'=>1],
