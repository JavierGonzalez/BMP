...
$action = sql("SELECT blockchain, height, (SELECT hash FROM blocks WHERE height = actions.height LIMIT 1) AS block_hash, txid, address, time, op_return, action, action_id, p1, p2, p3, p4, p5, p6, power, hashpower FROM actions WHERE txid = '".e($_GET[1])."'")[0];
